...
export default async function BacktestedDetail({ params }: PageProps) {
    ...
    for (const part of parts) {
      ...
      if (expMatch) {
        ...
        if (SWITCHER_SLUGS.has(slug) && EXPLORER_CONFIGS[key] && GC_EXPLORER_CONFIGS[key]) {
          ...
          explorerNode = <News830Explorer dataUrl={NEWS830_CONFIGS[key].dataUrl} pdfTitle={NEWS830_CONFIGS[key].pdfTitle} dataUrlGc={NEWS830_CONFIGS[key].dataUrlGc} pdfTitleGc={NEWS830_CONFIGS[key].pdfTitleGc} />;
        }
  ...
  if (isStraddleSwitcher && explorerKey && EXPLORER_CONFIGS[explorerKey] && GC_EXPLORER_CONFIGS[explorerKey]) {
    ...
    desktopExplorerNode = (
      <News830Explorer dataUrl={news830Config!.dataUrl} pdfTitle={news830Config!.pdfTitle} dataUrlGc={news830Config!.dataUrlGc} pdfTitleGc={news830Config!.pdfTitleGc} />
    );
  }
