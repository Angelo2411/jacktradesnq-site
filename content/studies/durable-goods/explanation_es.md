...
Durable Goods hits at 8:30 ET — factory orders for long-lasting goods: aircraft, machinery, electronics. You don't pick a side here: you bracket the release. A buy-stop sits above price, a sell-stop below, both set before the number drops, and whichever way the S&P 500 (ES) breaks, you're already in.
