PCE hits at 8:30 ET. It's the Fed's preferred inflation gauge — when it surprises, the move is clean and the Nasdaq listens.
...
No filter: 38 trades, profit factor 0.93, net -16 NQ points. With the S&P 500 filter: 29 trades, profit factor 1.34, net +45 NQ points.
...
29 filtered trades is a thin sample, so treat this as a read on the setup, not a guarantee. AI-assisted analysis, not financial advice.
