ICT post-news IFVG entry across 17 red-folder releases (CPI, NFP, PPI, RetailSales, PCE, GDP, JoblessClaims, EmpireState, ECI, FOMC, ADP, JOLTS, ISM Mfg, ISM Services, CB Confidence, Philly Fed, Durable Goods), with optional **GC SMT confirmation filter**. Tested 2016 → 2026 on SI 1m.
