...
Sample size: **102 releases** with valid 1-minute NQ bar data.
...
From **12.9 pts** in 2016 to **110.1 pts** in 2025 — an 8.5× expansion.
...
Bilateral straddle, full-port, **no stop loss**. AI-gathered data, not financial advice — backtest yourself.

After testing 24 combos across 102 NFP releases:

- **Stop offset: 100 pts** — past the typical manip-wick range
- **Take profit: 50 pts**
- Fill rate ~24%



<a class="bd-btn bd-btn-secondary" href="/downloads/studies/nfp-fullport.pdf" download>Download — NFP Fullport PDF</a>
