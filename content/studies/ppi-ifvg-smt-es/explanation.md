# PPI IFVG + NQ SMT — ES (S&P 500 Futures)

PPI — the wholesale inflation report — drops at 8:30 ET. The release usually manipulates one side of the pre-news range, then distributes in the real direction: it runs the stops sitting above or below, then reverses.
