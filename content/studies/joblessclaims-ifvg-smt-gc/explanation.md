# Jobless Claims IFVG + SI SMT (Gold)

10-year backtest of the Jobless Claims release at 8:30 ET on GC futures, using the IFVG entry pattern with SI (Silver) SMT confirmation.
