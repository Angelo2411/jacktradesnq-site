...
CPI arrives at 8:30 ET. The first move usually manipulates one side of the range, then distributes in the real direction: it runs the stops above or below the pre-news price, then reverses.
