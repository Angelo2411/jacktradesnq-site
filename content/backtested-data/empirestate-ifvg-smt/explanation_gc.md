ICT post-news IFVG entry on 8:30 ET Empire State releases, with optional **SI SMT confirmation filter**. Tested 2016 → 2026 on GC 1m (Gold COMEX, Databento .n.0 forward-filled).
...
Without SI SMT: 19 trades, PF 0.01, net -20.4 GC pts. With SI SMT: 0 trades — no SI confirmation triggered.

0 SMT-filtered trades — no SI confirmation ever triggered.
...
19 total setups, 0 SMT-filtered trades. AI-assisted analysis — not financial advice.
