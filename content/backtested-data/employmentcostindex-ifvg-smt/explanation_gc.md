ICT post-news IFVG entry on 8:30 ET Employment Cost Index (ECI) releases, with optional **SI SMT confirmation filter**. Tested 2016 → 2026 on GC 1m (Gold COMEX, Databento .n.0 forward-filled).
...
Without SI SMT: 7 trades, PF 3.71, net +5.7 GC pts. With SI SMT (2 trades): WR 100%, PF ∞, net +4.7 GC pts.

Very small sample (7 setups / 2 SMT). Quarterly release.
...
7 total setups, 2 SMT-filtered trades. AI-assisted analysis — not financial advice.
