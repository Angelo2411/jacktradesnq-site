ICT post-news IFVG entry on 8:30 ET CPI releases, with optional **SI SMT confirmation filter**. Tested 2016 → 2026 on GC 1m (Gold COMEX, Databento .n.0 forward-filled).
...
Without SI SMT: 38 trades, PF 1.08, net +5.4 GC pts. With SI SMT (1 trades): WR 0%, PF —, net -0.2 GC pts.
...
38 total setups, 1 SMT-filtered trades. AI-assisted analysis — not financial advice.
