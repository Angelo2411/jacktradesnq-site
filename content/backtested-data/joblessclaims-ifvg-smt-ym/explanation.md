# Jobless Claims · IFVG + SMT — YM (E-mini Dow)

10-year backtest of the IFVG reversal pattern on Jobless Claims releases at 8:30 ET, using NQ (E-mini Nasdaq) as the SMT confirmation leg.
