# CB Consumer Confidence · IFVG + SMT — YM (E-mini Dow)

10-year backtest of the IFVG reversal pattern on CB Consumer Confidence releases at 10:00 ET, using NQ (E-mini Nasdaq) as the SMT confirmation leg.
