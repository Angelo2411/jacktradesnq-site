# Empire State · IFVG + SMT — YM (E-mini Dow)

10-year backtest of the IFVG reversal pattern on Empire State releases at 8:30 ET, using NQ (E-mini Nasdaq) as the SMT confirmation leg.
