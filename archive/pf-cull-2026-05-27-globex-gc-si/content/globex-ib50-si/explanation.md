...
Trailing 12 months (TP 1.75): **210 trades, profit factor 1.02, net +0.5 points**, win rate 39%. This is breakeven — silver shows **no exploitable edge** for this setup. Published for honesty and to document that the IB50 framework does not transfer to SI.
